...
export class DatePickerPage extends BasePage {
	...
	constructor(page: Page) {
		...
		this.rightArrow = this.page.locator('nb-calendar-pageable-navigation [data-name="chevron-right"]');
		...
		this.rangeCell = this.page.locator('[class="range-cell day-cell ng-star-inserted"]');
	}
